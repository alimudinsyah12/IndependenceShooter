 ...
 * @author aimgs
 */
public class AboutMenuPlayerFrame extends JFrame{
    private AboutMenuPlayerPanel  aboutMenuPlayerPanel ; // the atribute
    public AboutMenuPlayerFrame(){
        ...
        this.aboutMenuPlayerPanel  = new AboutMenuPlayerPanel (this);
        this.getContentPane().add(aboutMenuPlayerPanel ); // adding the MainPanel to the frame
